...
function App() {
  ...
  useEffect(() => {
    const getToDos = async () => {
      try {
        const response = await fetch('https://asbendra-todo-app-backend.onrender.com/api/todo');
  ...
  const createToDo = async (e) => {
    e.preventDefault();
    try {
      const res = await fetch('https://asbendra-todo-app-backend.onrender.com/api/todo', {
        method: "POST",
